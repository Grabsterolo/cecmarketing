...
export const taStyle = {
  ...
  borderRadius: 8, padding: "8px 16px", color: COLORS.text, fontSize: 14,
...
export const btnCancelStyle = {
  ...
  borderRadius: 8, padding: "12px 16px", color: COLORS.textMuted, fontSize: 14,
...
export const btnSubmitStyle = {
  ...
  border: "none", borderRadius: 8, padding: "12px 16px", color: "#FFF", fontSize: 14,
